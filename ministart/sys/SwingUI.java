...
import x.ministart.parse.Parseur;
...
public class SwingUI extends JPanel {
	...
	public JPanel getConsole_panel(){
	...
	public JMenuBar getJMenuBar() {
		...
		if (this.menuBar == null){
			...
			menu.add (submenu = new JMenu ("Open Example"));
				...
				item.addActionListener (new ActionListener() {
					public void actionPerformed (ActionEvent e) {
						fichier = "data/LesMiserables_pg135.txt" ;
				...
				item.addActionListener (new ActionListener() {
					public void actionPerformed (ActionEvent e) {
						fichier = "data/LesTroisMousquetaires_pg13951.txt" ;
				...
				item.addActionListener (new ActionListener() {
					public void actionPerformed (ActionEvent e) {
						fichier = "data/Monte-Cristo_Tome1_pg17989.txt" ;
				...
				item.addActionListener (new ActionListener() {
					public void actionPerformed (ActionEvent e) {
						fichier = "data/Monte-Cristo_Tome2_pg17990.txt" ;
				...
				item.addActionListener (new ActionListener() {
					public void actionPerformed (ActionEvent e) {
						fichier = "data/Monte-Cristo_Tome3_pg17991.txt" ;
				...
				item.addActionListener (new ActionListener() {
					public void actionPerformed (ActionEvent e) {
						fichier = "data/Monte-Cristo_Tome4_pg17992.txt" ;
						new OpenFileWorker(ui, "data/Monte-Cristo_Tome4_pg17992.txt");
					}
				});
			menu.addSeparator();
			menu.add (item = new JMenuItem ("Open File"));
			item.addActionListener (new ActionListener() {
				public void actionPerformed (ActionEvent e) {
					...
					int retval = chooser.showOpenDialog(SwingUI.this);
					if (retval == JFileChooser.APPROVE_OPTION)
					{
						fichier  = chooser.getSelectedFile().getAbsolutePath() ;
						new OpenFileWorker(ui, fichier);
					}
				}
			});
			...
			//=============================Search Menu
			this.menuBar.add (menu = new JMenu ("KWIC"));
			menu.add (item = new JMenuItem("chercher un mot"));
			item.addActionListener (new ActionListener() {
				public void actionPerformed (ActionEvent e) {
					ui.console_txtarea.setText(new String());
					Search sc = new Search(ui);
					sc.setVisible(true);
					System.out.println("le fichier est:"+ui.fichier);
				}
			});
			...
			menu.add (item = new JMenuItem ("Parse de nom"));
			item.addActionListener (new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					new Parseur(ui);
